...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "FlxAtlas", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "FlxAtlas";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "FlxAtlas", null, { width: 640, height: 480 });
